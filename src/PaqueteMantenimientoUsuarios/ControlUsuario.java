...
public class ControlUsuario {
    ...
    public void registrarUsuarioMaestro(String idUsuario, String nombreUsuario, String contraseña) throws SQLException, ClassNotFoundException {
        ...
        instruccion.executeUpdate("INSERT INTO usuario(idUsuario,tipo,nombreUsuario,contrasena) values('" + Integer.parseInt(idUsuario) + "','MAESTRO ','" + nombreUsuario + "','" + contraseña + "') ");
    ...
    public void modificarUsuarioMaestro(String idUsuario, String nombreUsuario, String contraseña) throws SQLException, ClassNotFoundException {
        Statement instruccion = conectar();
        //inserccion a la base de datos
        instruccion.executeUpdate("UPDATE `usuario` SET `nombreUsuario`='" + nombreUsuario + "',`contrasena`='" + contraseña + "' WHERE `idUsuario`='" + Integer.parseInt(idUsuario) + "'");
    ...
    public ResultSet consultarGeneral() throws ClassNotFoundException, SQLException {
        ...
        //instruccion para obtener informacion
        //consulta la base de datos
        ResultSet conjuntoResultados = instruccion.executeQuery("SELECT *  FROM usuario where idUsuario=");
        return conjuntoResultados;
    }
    ...
    public ResultSet consultarDatosUsuario(String idUsuario) throws ClassNotFoundException, SQLException {
        ...
        //instruccion para obtener informacion
        //consulta la base de datos
        ResultSet conjuntoResultados = instruccion.executeQuery("SELECT nombreUsuario,contrasena  FROM usuario where idUsuario=" + Integer.parseInt(idUsuario) + "");
        return conjuntoResultados;
    }
    ...
    public ResultSet consultar(String idUsuario, String tipo) throws ClassNotFoundException, SQLException {
        ...
        //instruccion para obtener informacion
        //consulta la base de datos
        ResultSet conjuntoResultados = instruccion.executeQuery("SELECT nombreUsuario,contrasena  FROM usuario where idUsuario=" + Integer.parseInt(idUsuario) + " AND tipo='" + tipo + "'");
        return conjuntoResultados;
    }
    ...
    public void registrarUsuarioAlumno(String idUsuario, String nombreUsuario, String contraseña) throws SQLException, ClassNotFoundException {
        Statement instruccion = conectar();
        //inserccion a la base de datos
        instruccion.executeUpdate("INSERT INTO usuario(idUsuario,tipo,nombreUsuario,contrasena) values('" + Integer.parseInt(idUsuario) + "','ALUMNO ','" + nombreUsuario + "','" + contraseña + "') ");
