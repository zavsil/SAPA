...
public class ControlEvaluacion {
    ...
    public void registrar(int idUsuario, int totalReactivos[], int idMateria, String nombreMateria, int grado, float puntaje[]) throws SQLException, ClassNotFoundException {
        ...
        if (idEvaluacion != -1) {
            ...
            instruccion = conectar();
            //inserccion a la base de datos
            instruccion.executeUpdate("INSERT INTO evaluacion_reactivos_puntaje (idEvaluacion_Reactivos_P,puntuaje1,puntuaje2,puntuaje3,puntuaje4,puntuaje5,puntuaje6,puntuaje7,puntuaje8,puntuaje9,puntuaje10,puntuaje11,puntuaje12,puntuaje13,puntuaje14,puntuaje15,puntuaje16,puntuaje17,puntuaje18,puntuaje19,puntuaje20) VALUES ( '" + idEvaluacionObtenida + "',  '" + puntaje[0] + "','" + puntaje[1] + "','" + puntaje[2] + "','" + puntaje[3] + "','" + puntaje[4] + "','" + puntaje[5] + "','" + puntaje[6] + "','" + puntaje[7] + "','" + puntaje[8] + "','" + puntaje[9] + "','" + puntaje[10] + "','" + puntaje[11] + "','" + puntaje[12] + "','" + puntaje[13] + "','" + puntaje[14] + "','" + puntaje[15] + "','" + puntaje[16] + "','" + puntaje[17] + "','" + puntaje[18] + "','" + puntaje[19] + "');");
     ...
     * realizada
     */
    public boolean aplicarEvaluacion(int idEvaluacion, int grado, String grupo, int materia) throws ClassNotFoundException, SQLException {
        Statement instruccion = conectar();

        ResultSet resultados = instruccion.executeQuery("select idGrupo from grupo where grado='" + grado + "' and grupo='" + grupo + "';;");
        int idGrupo = 0;
        while (resultados.next()) {
            idGrupo = Integer.parseInt(resultados.getObject(1).toString());
        }

        ResultSet resultado = instruccion.executeQuery("select count(*) from evaluacion_grupo where grado='" + grado + "' and idGrupo='" + idGrupo + "';");
        boolean existe = false;
        while (resultado.next()) {
            if (Integer.parseInt(resultado.getObject(1).toString()) == idEvaluacion) {
                existe = true;
            }

        }
        //si no se ha aplicado la evalucion la aplica
        if (!existe) {
            //inserccion a la base de datos
            instruccion.executeUpdate("INSERT INTO evaluacion_grupo (idEvaluacion,grado,idGrupo,materia) VALUES ('" + idEvaluacion + "', '" + grado + "', '" + idGrupo + "', '" + materia + "');");
     ...
     * Metodo que regresa el contenido de la evaluacion indicada
     */
    public ResultSet consultarContenido(String nombreEvaluacion) throws ClassNotFoundException, SQLException {
        Statement instruccion = conectar();
        ResultSet resultadosReactivo = instruccion.executeQuery("select * from evaluacion_reactivos join evaluacion on evaluacion_reactivos.idReactivosRelacionados=evaluacion.idReactivosRelacionados  and evaluacion.nombre='" + nombreEvaluacion + "';");
        return resultadosReactivo;
    }
    ...
    public Statement conectar() throws ClassNotFoundException, SQLException {
        ...
        //crea objetos Statement para consultarNombre la base de datos
